...
export const fetchProductsByFilter = createAsyncThunk("products/fetchProductsByFilter", async ({
    collection,
    size,
    color,
    gender,
...
export const fetchProductDetails = createAsyncThunk("products/fetchProductDetails", async (id) => {
    // console.log("Product Details fetching started with id .." , id);
