...
const FeaturedCollection = () => {
  return (
    <section className='py-16 px-4 lg:px-0'>
        <div className='mx-auto container flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl'>
            {/* left content */}
            ...
            <div className='lg:w-1/2'>
                <img src={featuredImg} alt='Featued Collection' className='h-full w-full object-cover lg:rounded-tr-3xl lg:rounded-br-3xl'/>
            </div>
        </div>
    </section>
  )
