    ...
    <div className='max-w-5xl mx-auto p-6  shadow-md rounded-md'>
        ...
        <form onSubmit={handleOnSubmit}>
            ...
            <div className='mb-6'>
                ...
                <input className='bg-gray-300' placeholder='Choose File' type='file' onChange={handleImageUpload}/>
            ...
            <button type='submit' className='w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition-colors hover:cursor-pointer'>Update Product</button>
